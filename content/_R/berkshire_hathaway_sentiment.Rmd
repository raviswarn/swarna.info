...
```{r load packages, echo=F, error=F, message=F, warning=F}
...
```{r process, echo=F, error=F, message=F, warning=F, cache = T}
################################################################################
################################# Get Letters ##################################
################################################################################
...
```{r sentiment_list, fig.height = 9, fig.width=15, fig.align='center', error=F, message=F, warning=F, echo=F}
...
```{r wordcloud, fig.height = 10, fig.width = 10, fig.align='center', error=F, message=F, warning=F, echo=F}
tidy_letters %>%
  filter(sentiment != 'neutral') %>%
  count(word, sentiment, sort = TRUE) %>%
